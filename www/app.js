...
function tabProfilePoints(len, flip, tabSizeFrac, jitterAmt, centerTabs, rnd) {
  ...
  const centerSpread = centerTabs ? 0 : 0.15 + jitterAmt * 0.35;
...
function buildSVG({ W, H, cols, rows, tabSizeFrac, jitterAmt, centerTabs, seed, strokeColor, includePhoto, includeBorder }) {
...
function renderPreview() {
  ...
  lastSVGString = buildSVG({ W, H, cols, rows, tabSizeFrac, jitterAmt, centerTabs, seed, strokeColor, includePhoto, includeBorder });
